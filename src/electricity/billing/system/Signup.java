...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup(){
        ...
        create.setBackground(new Color(31, 80, 104 ));
        ...
        back.setBackground(new Color(31, 80, 104));
        back.setForeground(Color.WHITE);
        back.setBounds(180,285,100,25);
        back.addActionListener(this);
        add(back);

        ImageIcon boyIcon1 = new ImageIcon(ClassLoader.getSystemResource("icon/boy.png"));
        Image boyIcon2 = boyIcon1.getImage().getScaledInstance(250,250,Image.SCALE_DEFAULT);
        ImageIcon boyIcon3 = new ImageIcon(boyIcon2);
        JLabel boyLabel = new JLabel(boyIcon3);
        boyLabel.setBounds(330,45,250,250);
        add(boyLabel);
